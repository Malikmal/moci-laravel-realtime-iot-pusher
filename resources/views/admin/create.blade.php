                        ...
                        <div class="col-sm">
                            <form action="{{route('device.store')}} ", method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="description" class="form-control mt-15" rows="3" placeholder="Description" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="coordinate" class="col-sm-2 col-form-label">Coordinate</label>
                                    <div class="col-sm-10">
                                        <input name="coordinate" type="text" class="form-control" placeholder="x.xxxxxx, y.yyyyyy">
                                    </div>
                                </div>
