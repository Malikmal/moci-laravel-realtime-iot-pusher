...
<div class="container mt-xl-50 mt-sm-30 mt-15">
    ...
    <div class="hk-pg-header align-items-top">
        <div>
			<h2 class="hk-pg-title font-weight-600 mb-10">Temperatur Analytics</h2>
		...
		<div class="d-flex w-250p">
			...
			<select class="form-control custom-select custom-select-sm mr-15" onchange="location=this.value">
                @foreach ($device as $item)
                    ...
                    <option
                        value="{{route('temperature', $item->id)}} "
                        @if ($item->id == $id)
                            selected
                        @endif
                    >{{$item->place}}</option>
					...
					<div class="card-group hk-dash-type-2">
						<div class="card card-sm">
							<div class="card-body">
								<div class="d-flex justify-content-between mb-5">
									<div>
										<span class="d-block font-15 text-dark font-weight-500">Current Temperature</span>
									</div>
									<div>
								...
								<div>
									<span class="d-block display-4 text-dark mb-5"><span class="counter-anim" id="current_temp">34° C</span></span>
						...
						<div class="card card-sm">
							<div class="card-body">
								...
								<div>
									<span class="d-block display-4 text-dark mb-5">{{$thisday['morning']->temp ?? ''}}° C</span>
						...
						<div class="card card-sm">
							<div class="card-body">
								...
								<div>
									<span class="d-block display-4 text-dark mb-5">{{$thisday['afternoon']->temp ?? ''}}° C</span>
						...
						<div class="card card-sm">
							<div class="card-body">
								...
								<div>
									<span class="d-block display-4 text-dark mb-5">{{$thisday['evening']->temp ?? ''}}° C</span>
										...
										<tbody>
                                            @foreach ($daily as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="progress-wrap lb-side-left mnw-75p">
                                                            <div class="progress-lb-wrap">
                                                                <label class="progress-label mnw-50p">{{round($item->temp, 2)}}°C</label>
                                                    ...
                                                    <td>{{round($item->tempMin, 2)}}°C</td>
                                                    <td>{{round($item->tempMax, 2)}}°C</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="progress-wrap lb-side-left mnw-75p">
                                                            <div class="progress-lb-wrap">
                                                                <label class="progress-label mnw-50p">°C</label>
                                                                {{-- <div class="progress progress-bar-rounded progress-bar-xs">
                                                                    <div class="progress-bar bg-primary w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                                                </div> --}}
                                                            </div>
											...
											{{-- <tr>
												...
												<td>
													<div class="progress-wrap lb-side-left mnw-125p">
														<div class="progress-lb-wrap">
															<label class="progress-label mnw-50p">27° C</label>
															<div class="progress progress-bar-rounded progress-bar-xs">
																<div class="progress-bar bg-primary w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
											...
											<tr>
												...
												<td>
													<div class="progress-wrap lb-side-left mnw-125p">
														<div class="progress-lb-wrap">
															<label class="progress-label mnw-50p">29° C</label>
															<div class="progress progress-bar-rounded progress-bar-xs">
																<div class="progress-bar bg-brown-light-3 w-70" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="progress-wrap lb-side-left mnw-125p">
														<div class="progress-lb-wrap">
															<label class="progress-label mnw-50p">30° C</label>
															<div class="progress progress-bar-rounded progress-bar-xs">
																<div class="progress-bar bg-brown-light-4 w-60" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</div>
												</td>
											...
											<tr>
												...
												<td>
													<div class="progress-wrap lb-side-left mnw-125p">
														<div class="progress-lb-wrap">
															<label class="progress-label mnw-50p">33° C</label>
															<div class="progress progress-bar-rounded progress-bar-xs">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="progress-wrap lb-side-left mnw-125p">
                                                        <div class="progress-lb-wrap">
                                                            <label class="progress-label mnw-50p">26° C</label>
                                                            <div class="progress progress-bar-rounded progress-bar-xs">
                                                                <div class="progress-bar bg-danger w-55" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                        </div>
...
@push('script')
    ...
    //         }
    //         document.getElementById('current_temp').innerHTML = current + "° C";
	...
	@foreach($sensor as $item)
		...
		sensors[{{ count($sensor) - $loop->iteration}} - 1] = [{{ count($sensor) - $loop->iteration}} - 1, {{$item->temp}}]
	@endforeach

	// @for($i = count($sensor) - 1; $i >= 0 ; $i--)

	// 	sensors[$i] =  [{{$i}}, {{$sensor[$i]->temp}}];
    ...
    channel.bind('my-event', function(data) {
        if(data.id == {{$id}})
        {
            ...
            // this.sensors.push([this.sensors.length, parseInt(data.temperature)]);
            ...
            // this.sensors.push([this.sensors.length, parseInt(data.temperature)]);
            // dataGraph.push(this.sensors.length, data.temperature);
            var fill_line_chart_data = {
                data : newSensors
            }
        ...
        if( $('#sparkline_1').length > 0 ){
            ...
            @foreach($daily as $item)
                ...
                @foreach($item->collect as $item2)
                    <?php $j++; ?>
                    temperature[{{$j - 1}}] = {{round($item2->temp, 2)}};
                    @if($j > 8)
                        @break
                    @endif
                @endforeach
                $("#sparkline_{{$i}}").sparkline(temperature, {
                    type: 'line',
                    width: '100',
                    height: '34',
                    resize: true,
